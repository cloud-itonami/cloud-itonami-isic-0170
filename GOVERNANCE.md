...
cloud-itonami-isic-0170 is steered by the [cloud-itonami](https://itonami.cloud)
...
- **Harvest-method/Jurisdiction facts**: open for PR contribution with test coverage
...
- Harvest methods and jurisdictions can be extended without breaking Governor logic
- Semantic versioning reflects backward compatibility of the Governor interface

## Dispute Resolution

Disagreements about wildlife-harvest safety/regulatory constraints or the
