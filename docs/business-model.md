# Business Model: Hunting, Trapping And Related Service Activities Coordination
...
## Classification
- Repository: `cloud-itonami-isic-0170` ([github.com/cloud-itonami/cloud-itonami-isic-0170](https://github.com/cloud-itonami/cloud-itonami-isic-0170))
- ISIC Rev.5: `0170` — Hunting, Trapping And Related Service Activities Coordination
- Domain: `:agriculture/hunting-trapping-services`
- Social impact: :food-security :conservation :wildlife-harvest-safety
- Actor: `:huntharvest-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :agriculture/hunting-trapping-services — who wants
...
Capability stack (required): :identity :forms :dmn :bpmn :audit-ledger :telemetry.
...
One managed tenant (:agriculture/hunting-trapping-services):
...
- Do not bypass the `:huntharvest-governor` for production decisions.
